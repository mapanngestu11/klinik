            ...
            <div id="content">
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <p class="animated fadeInDown">
                          Pasien <span class="fa-angle-right fa"></span> Daftar Baru
                        </p>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-12">
                    ...
                    <div class="row">
                     <div class="col-md-4">
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input name="kode_pasien" type="text" class="form-text" required>
                        <span class="bar"></span>
                     ...
                     <div class="col-md-7">
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input name="nama" type="text" class="form-text" required>
                        <span class="bar"></span>
                ...
                <div class="row">
                  ...
                  <div class="col-md-5">
  <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input name="nik" type="text" class="form-text" required>
                        <span class="bar"></span>
                        <label>NIK</label>
                      </div>
    </div>                            
                    ...
                    <div class="col-md-2">
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input name="usia" type="number" class="form-text" required>
                        <span class="bar"></span>
                        <label>Usia</label>
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-11">
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input name="alamat" type="text" class="form-text" >
                        <span class="bar"></span>
                        <label>Alamat</label>
                      </div>
                    </div>
