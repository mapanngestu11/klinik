                            ...
                            <div class="col-md-12 padding-0">
                                    ...
                                    <div class="panel box-v1">
                                      <div class="panel-heading bg-white border-none">
                                        <div class="col-md-6 col-sm-6 col-xs-6 text-left padding-0">
                                          <h4 class="text-left">Data Antrian Pasien</h4>
                                        </div>
                                      ...
                                      <?php 
                                        include 'koneksi.php';
                                       $tgl = date("d-M-Y");
                                        $query = "SELECT * FROM `rekam_medis` Where tanggal ='$tgl' AND status = 'tunggu' ORDER BY `waktu` ASC  ";
                                ...
                                <div class="col-md-6">
                                    <div class="panel box-v1">
                                      <div class="panel-heading bg-white border-none">
                                        <div class="col-md-6 col-sm-6 col-xs-6 text-left padding-0">
                                          <h4 class="text-left">Data Rekam Medis </h4>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6 text-right">
                                           <h4>
                                           <span class="fa fa-user-md icons icon text-right"></span>
                                           </h4>
                                        </div>
                                      </div>
                                      <?php 
                                        include 'koneksi.php';
                                        $query = "SELECT DISTINCT kode_pasien FROM `rekam_medis`";
                                        $hasil = mysqli_query($koneksi,$query);
                                        $data  = mysqli_num_rows($hasil);
