                  ...
                  <div class="responsive-table">
                    <table id="datatables-example" class="table table-striped table-bordered" width="100%" cellspacing="0">
                      ...
                      <tbody>
                       ...
                       $tgl = date("d-M-Y");
                       $no = 1;
                       $data = mysqli_query($koneksi,"SELECT * FROM `rekam_medis` Where tanggal ='$tgl' AND status = 'tunggu' ORDER BY `waktu` ASC");
                       while($d = mysqli_fetch_array($data)){
                        ...
                        <tr>
                         ...
                         <td align="center"><a href="#" data-id="<?php echo $d['id_data']; ?>"class="btn btn-round btn-detail btn-primary btn-sm"data-toggle="modal" data-target="#detailPesan"><i class="fa fa-pencil"></i> Tambah</a></td>
...
<div class="modal fade" id="detailPesan" tabindex="-1" role="dialog" aria-labelledby="Tambah Barang" aria-hidden="true">
      ...
      <div class="modal-header">
          <h5 class="modal-title" id="Tambah Barang">Berikan Keterangan Obat</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
          </button>
      </div>
          <form action="update-data-rekam-medis.php" method="post" >
...
<script type="text/javascript">
    $('.btn-detail').click(function(){
      $.get('detail_data.php?id_data='+$(this).data('id'),function(data){
        console.log(data)
