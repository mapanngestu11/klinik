        ...
        <div id="content">
         <div class="panel box-shadow-none content-header">
          <div class="panel-body">
            <div class="col-md-12">
              <h3 class="animated fadeInLeft">Resep Obat</h3>
            ...
            <div class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="responsive-table">
                  <a href="" class="btn btn-primary btn-sm pull-left btn-round"data-toggle="modal" data-target="#TambahBarang">Tambah Data Resep</a>
                  <br>
                  <br>
                   <div class="modal fade" id="TambahBarang" tabindex="-1" role="dialog" aria-labelledby="Tambah Barang" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="Tambah Barang">Tambah Data Resep</h5>
        ...
        <div class="modal-body">
            ...
            <form method="post" action="add-resep.php">
                                <div class="form-group">
                                  <label for="Kode Barang" class=" form-control-label">Nama Dokter</label>
                              ...
                              while ($data = mysqli_fetch_assoc($result)) {
                               ...
                               <div class="form-group">
                                  <label for="Nama Barang" class=" form-control-label">Nama Pasien</label>
                     ...
                     while($d = mysqli_fetch_array($data)){
                      ...
                      <tr>
                        ...
                        <td><?php echo $d['resep']; ?></td>
                         ...
                         <td align="center"><a href="#" data-id="<?php echo $d['id_resep']; ?>"class="btn btn-round btn-detail btn-warning btn-sm"data-toggle="modal" data-target="#detailPesan"> <i class="fa fa-pencil"> </i> Edit</a></td>
                        <td align="center"><a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ?')){ location.href='hapus_data_resep.php?id_resep=<?php echo $d['id_resep']; ?>' }" class="btn btn-round btn-danger"><i class="fa fa-trash"></i> Hapus</a></td>
                    <?php 
                  }
                  ?>
                      </tr> 
...
<div class="modal fade" id="detailPesan" tabindex="-1" role="dialog" aria-labelledby="Tambah Barang" aria-hidden="true">
      ...
      <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title" id="Tambah Barang">Edit Resep</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
          </button>
      </div>
          <form method="post" action="update-resep.php">
          <div class="modal-body" id="bodyDetail">

      </div>
      
   <div class="modal-footer" id="bodyDetail">
...
<script type="text/javascript">
    $('.btn-detail').click(function(){
      $.get('detail-resep.php?id_resep='+$(this).data('id'),function(data){
        console.log(data)
