...
$sql = "INSERT INTO `kwitansi` (`id_kwitansi`,`nama_pasien`,`nama_dokter`,
	...
	if (!$tambahdata) {
		...
		echo "<script> alert ('Gagal Menambah Data');window.location.href='add.kwitansi.php?nama_pasien=<?php echo $d[nama_pasien]; ?>';</script>";		
	}
	else{
		
		echo "<script> alert ('Data Ditambahkan');window.location.href='index.php';</script>";		
	}
