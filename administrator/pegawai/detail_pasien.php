...
<body id="mimin" class="dashboard">
      ...
      <div class="container-fluid mimin-wrapper">
            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Pasien</h3>
                        <p class="animated fadeInDown">
                          Pasien <span class="fa-angle-right fa"></span> Detail Data Pasien
                        </p>
                    </div>
                  </div>
                </div>
          ...
          ?>
                <form action="update_regis_pasien.php" method="post">
              ...
              <div class="col-md-12">
                <div class="col-md-12 panel">
                  ...
                  <div class="col-md-12 panel-body">
                    <div class="row">
                     <div class="col-md-4">
                        <input type="text" name="id_pasien" value="<?php echo$d['id_pasien']?>" hidden> 
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input name="kode_pasien" type="text" class="form-text" required value="<?php echo$d['kode_pasien']?>">
                        <span class="bar"></span>
                     ...
                     <div class="col-md-7">
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input name="nama" type="text" class="form-text" value="<?php echo$d['nama']?>" required>
                        <span class="bar"></span>
                ...
                <div class="row">
                  ...
                  <div class="col-md-5">
  <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input name="nik" type="text" class="form-text" value="<?php echo$d['nik']?>" required>
                        <span class="bar"></span>
                        <label>NIK</label>
                      </div>
    </div>                            
                    ...
                    <div class="col-md-2">
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input name="usia" type="number" class="form-text" value="<?php echo$d['usia']?>" required>
                        <span class="bar"></span>
                        <label>Usia</label>
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-11">
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input name="alamat" type="text" class="form-text" value="<?php echo$d['alamat']?>">
                        <span class="bar"></span>
                        <label>Alamat</label>
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-7">
                    <br>
                       <label>Keterangan Data Pasien</label>
            ...
            ?>
              ...
              <a class="btn btn-primary" href="list.pasien.php">Kembali </a>
                 ...
                 <hr>
                <h2 align="center">REKAM MEDIS PASIEN</h2>
                <hr style="bold">
                <div class="row">
                  <div class="col-md-3">
                     <?php
...
th {
  ...
  color: white;
                ...
                <br>
                <h4 align="center">KLINIK INSAN PERMATA</h4>
              </div>
              </div>
              </div>
              </div>
