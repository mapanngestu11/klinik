          ...
          <div class="panel-body">
            <div class="col-md-12">
              ...
              <p class="animated fadeInDown">
                Pasien <span class="fa-angle-right fa"></span> Pendataan Pasien
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-12 top-20 padding-0">
          <div class="col-md-12">
            <div class="panel">
              ...
              <div class="panel-body">
                <button data-toggle="modal" data-target="#exampleModalLabel" class="btn btn-primary" ><i class="fa fa-user-plus"></i> Tambah</button>
                <!-- tambah data -->
                  ...
                  <div role="document" class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 id="exampleModalLabel" class="modal-title">Pendataan Pasien Hari ini</h4>
                        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
                      </div>
                      <div class="modal-body">
                        <p>Data Tersebut akan Tercatat Pada Rekam Medis Pasien.</p>
                        <form action="add_pasien.php" method="post">
                          <div class="form-group">
                            <label>Nama Pasien</label>
                            <select name="nama" class="form-control" required oninvalid="this.setCustomValidity('Field Tidak Boleh Kosong')" oninput="setCustomValidity('')"> 
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" placeholder="Keluhan Penyakit" name="penyakit" class="form-control">
                            </div>
                          </div>
                      ...
                      <tbody>
                       ...
                       while($d = mysqli_fetch_array($data)){
                        ...
                        <tr>
                          ...
                          <td align="center"><a href="detail_pasien.php?id_pasien=<?php echo $d['id_pasien']; ?>" class="btn btn-round btn-info"><i class="fa fa-search"></i> Detail</a></td>
