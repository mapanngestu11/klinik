            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Akun</h3>
                        <p class="animated fadeInDown">
                          Akun <span class="fa-angle-right fa"></span> Buat Akun
                        </p>
                    </div>
                  </div>
                </div>
            ...
            ?>          
              ...
              <div class="col-md-12">
                    ...
                    <div class="row">
                     <div class="col-md-9">
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        ...
                        <input name="id_user" type="text" value="<?php echo $d['id_user'];?>" hidden>
                        <span class="bar"></span>
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
  <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input name="username" type="text" class="form-text"  value="<?php echo $d['username'];?>" required>
                        <span class="bar"></span>
                    ...
                    <div class="col-md-3">
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input name="password" type="password" class="form-text" value="<?php echo $d['password'];?>" required>
                        <span class="bar"></span>
                    ...
                    <div class="col-md-3">
                      <div class="form-group form-animate-text" style="margin-top:40px !important;">
                        <input name="kode_user" type="text" class="form-text" value="<?php echo $d['kode_user'];?>" required>
                        <span class="bar"></span>
              ...
              ?>
               ...
               <a href="list.akun.php" class="btn btn-grey">Kembali</a>
                </div>
              </div>
              </div>
              </div>
