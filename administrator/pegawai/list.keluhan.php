                     ...
                     while($d = mysqli_fetch_array($data)){
                      ...
                      <tr>
                        ...
                        <td ><?php echo $d['perihal']; ?></td>
                         ...
                         <td align="center"><a href="#" data-id="<?php echo $d['id_pesan']; ?>"class="btn btn-round btn-detail btn-primary btn-sm"data-toggle="modal" data-target="#detailPesan"><i class="fa fa-search"></i> Detail</a></td>
                        <td align="center"><a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ?')){ location.href='hapus_keluhan.php?id_pesan=<?php echo $d['id_pesan']; ?>' }" class="btn btn-round btn-danger"><i class="fa fa-trash"></i> Hapus</a></td>
                      <?php 
                  }
                  ?>
                      </tr> 
...
<div class="modal fade" id="detailPesan" tabindex="-1" role="dialog" aria-labelledby="Tambah Barang" aria-hidden="true">
      ...
      <div class="modal-header">
          <h5 class="modal-title" id="Tambah Barang">Keluhan Pasien</h5>
...
<script type="text/javascript">
    $('.btn-detail').click(function(){
      $.get('detail-pesan.php?id_pesan='+$(this).data('id'),function(data){
        console.log(data)
        $('#bodyDetail').html(data)
        $('#bodyDetail :input').attr('readonly',true)
      })
    })
    </script>
<!-- end: Javascript -->
