        ...
        <div id="content">
         <div class="panel box-shadow-none content-header">
          <div class="panel-body">
            <div class="col-md-12">
              <h3 class="animated fadeInLeft">Data Dokter</h3>
              <p class="animated fadeInDown">
                Dokter <span class="fa-angle-right fa"></span> Lihat Semua
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div role="document" class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 id="exampleModalLabel" class="modal-title">Data Dokter</h4>
                        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
                      </div>
                      <div class="modal-body">
                        <p>Data Diri Dokter</p>
                        <form action="add_dokter.php" method="post">
                          <div class="form-group">
                            ...
                            <input type="number" name="no_hp" class="form-control" placeholder="0812xxx" required>
                            </div>
                            <div class="form-group">
